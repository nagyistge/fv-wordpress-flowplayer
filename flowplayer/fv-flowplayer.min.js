...
if( typeof(fv_flowplayer_admin_test_media_array) != "undefined" ) {
	var fv_flowplayer_scroll_video_checker = true;
...
if( typeof(flowplayer.conf.safety_resize) != "undefined" && flowplayer.conf.safety_resize ) {
  setTimeout( function() { fv_flowplayer_safety_resize(); }, 10 );
}
...
jQuery('.fp-playlist-external' ).each( function(i,el) {
  ...
  jQuery('a',el).click( function(e) {
    ...
    fv_player_playlist_active(el,this);
...
flowplayer( function(api,root) {
  ...
  if( playlist.length ){
    ...
    check_size_and_all();
    jQuery(window).resize( function() { check_size_and_all() } );
  }
...
flowplayer(function(player, root) {
  ...
  if( !/iPhone OS 10/.test(navigator.userAgent) ) return;
...
function fv_player_notice(root, message, timeout) {
  var notice = jQuery('<div class="fvfp-notice"><div class="fvfp-notice-content">'+message+'</div></div>');
  jQuery('.fp-ui',root).append(notice);
